These files will read the temperature from a DS1624 which is a cheap and easy to source Board Mount Temperature Sensor
...
There are 2 variants of the TempRead program, but I cannot remember what the difference is and I am to tired to check right now.
...
LEDTest.py simply flashes the LED's to make sure they are working.
